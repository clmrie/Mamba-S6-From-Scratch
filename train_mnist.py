...
def main():
    ...
    PARAM_FILE = os.path.join(RESULTS_DIR, "mnist_mamba_params.txt")
    ...
    mamba_params = count_trainable_params(model)
    print(f"Vision Mamba trainable parameters: {mamba_params:,}")
    with open(PARAM_FILE, "w") as f:
        f.write(f"{mamba_params}\n")
    ...
    print("MNIST Vision Mamba training complete. Results saved in results_mnist/")
